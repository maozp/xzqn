 ...
 * @Description:
 */
public class AuthSkillSerialize extends JsonSerializer<XzqnAuthSkill> {
    @Override
    public void serialize(XzqnAuthSkill value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        gen.writeStringField("skillCertificate", value.getSkillCertificate());
